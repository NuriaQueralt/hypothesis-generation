...
with driver.session() as session:
    ...
    with open('./out/{}.tsv'.format(args.output), 'w') as f:
        ...
        for pairwise in output:
            f.write('{}\t{}\t{}\t{}\t{}\t{}\t{}\n'.format(seed_dct[pairwise['source']], seed_dct[pairwise['target']], pairwise['paths'], pairwise['pathways'], pairwise['diseases'], pairwise['source_ortho'], pairwise['other_ortho']))
