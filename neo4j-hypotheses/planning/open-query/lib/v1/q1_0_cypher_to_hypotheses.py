...
with driver.session() as session:
    ...
    with open('./out/{}.tsv'.format(args.output), 'w') as f:
        f.write('paths_count\trelation_1\tnode_2\trelation_2\tnode_3\trelation_3\tnode_4\trelation_4\tnode_5\trelation_5\tnode_6\trelation_6\tmetapaths_count\n')
